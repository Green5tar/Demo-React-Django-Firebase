...
import { useAddUserMutation } from "../api/core_api"
...
const Signup = () => {
    ...
    const stateUser = useSelector(state => state.user.token);
    ...
    const onSubmit = async (e) => {
        ...
        await createUserWithEmailAndPassword(auth, email, password)
            .then((userCredential) => {
                ...
                addUser({ email: user.email, firebase_id: user.uid })
                dispatch(setUserData({ user: user }))
                console.log(stateUser, "userdatas")
                // navigate("/login")
                // ...
            })
            .catch((error) => {
